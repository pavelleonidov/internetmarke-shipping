...
package de.pavelleonidov.InternetmarkeShipping.printer.print;
...
import de.pavelleonidov.InternetmarkeShipping.printer.PageLayout;
...
import de.pavelleonidov.InternetmarkeShipping.printer.Printer.MarginType;
import de.pavelleonidov.InternetmarkeShipping.printer.PrinterAttributes;
...
public class J2DPrinterJob implements PrinterJobImpl {
    ...
    private void updatePrintQuality() {
        ...
        if (quality == PrintQuality.DRAFT) {
            settings.
                setPrintQuality(de.pavelleonidov.InternetmarkeShipping.printer.PrintQuality.DRAFT);
        } else if (quality == PrintQuality.HIGH) {
            settings.
                setPrintQuality(de.pavelleonidov.InternetmarkeShipping.printer.PrintQuality.HIGH);
        } else {
            settings.
                setPrintQuality(de.pavelleonidov.InternetmarkeShipping.printer.PrintQuality.NORMAL);
        }
    }
    ...
    private void syncPrintQuality() {
        de.pavelleonidov.InternetmarkeShipping.printer.PrintQuality
            quality = settings.getPrintQuality();
        PrintQuality j2DQuality;
        if (quality == de.pavelleonidov.InternetmarkeShipping.printer.PrintQuality.DRAFT) {
            j2DQuality = PrintQuality.DRAFT;
        } else if (quality == de.pavelleonidov.InternetmarkeShipping.printer.PrintQuality.HIGH) {
