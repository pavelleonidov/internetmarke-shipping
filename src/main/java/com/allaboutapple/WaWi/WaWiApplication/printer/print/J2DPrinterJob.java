...
package com.allaboutapple.WaWi.WaWiApplication.printer.print;

import com.allaboutapple.WaWi.WaWiApplication.printer.print.J2DPrinter;
...
import com.allaboutapple.WaWi.WaWiApplication.printer.Printer.MarginType;
import com.allaboutapple.WaWi.WaWiApplication.printer.PrinterAttributes;
...
public class J2DPrinterJob implements PrinterJobImpl {
    ...
    private void updatePrintQuality() {
        ...
        if (quality == PrintQuality.DRAFT) {
            settings.
                setPrintQuality(com.allaboutapple.WaWi.WaWiApplication.printer.PrintQuality.DRAFT);
        } else if (quality == PrintQuality.HIGH) {
            settings.
                setPrintQuality(com.allaboutapple.WaWi.WaWiApplication.printer.PrintQuality.HIGH);
        } else {
            settings.
                setPrintQuality(com.allaboutapple.WaWi.WaWiApplication.printer.PrintQuality.NORMAL);
        }
    }
    ...
    private Printer getFXPrinterForService(PrintService service) {
        ...
        for (Printer p : printerSet) {
            com.sun.prism.j2d.print.J2DPrinter p2d = (com.sun.prism.j2d.print.J2DPrinter)PrintHelper.getPrinterImpl(p);
    ...
    private void syncPrintQuality() {
        com.allaboutapple.WaWi.WaWiApplication.printer.PrintQuality
            quality = settings.getPrintQuality();
        PrintQuality j2DQuality;
        if (quality == com.allaboutapple.WaWi.WaWiApplication.printer.PrintQuality.DRAFT) {
            j2DQuality = PrintQuality.DRAFT;
        } else if (quality == com.allaboutapple.WaWi.WaWiApplication.printer.PrintQuality.HIGH) {
