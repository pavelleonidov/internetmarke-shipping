...
/**
 * Response-Datentyp der Methode registerEMailAdress
 * 
 * <p>Java-Klasse für registerEMailAdressResponseType complex type.
 * 
 * <p>Das folgende Schemafragment gibt den erwarteten Content an, der in dieser Klasse enthalten ist.
 * 
 * <pre>
 * &lt;complexType name="registerEMailAdressResponseType">
 *   &lt;complexContent>
...
@XmlType(name = "registerEMailAdressResponseType", propOrder = {
    "mandantID",
    "subMandantID",
    "registration",
...
public class RegisterEMailAdressResponseType {
