 ...
 *       &lt;choice>
 *         &lt;element name="Response" type="{urn:www-deutschepost-de:Product/ProductInformation/1.1/common}getCatalogListResponseType"/>
...
public class GetCatalogListResponse {
    ...
    protected GetCatalogListResponseType response;
     ...
     * @return
     *     possible object is
     *     {@link GetCatalogListResponseType }
     *     
     */
    public GetCatalogListResponseType getResponse() {
        return response;
    }
     ...
     *     
     */
    public void setResponse(GetCatalogListResponseType value) {
        this.response = value;
    }
